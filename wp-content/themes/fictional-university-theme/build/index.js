...
class MyNotes {
  constructor() {
    this.createbtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".submit-note");
    this.parentElmnt = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes");
    this.events();
  }
  events() {
...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), data => {
      console.log(data);
      this.resultsDiv.html(`
            <div class="row">
                <div class="one-third">
